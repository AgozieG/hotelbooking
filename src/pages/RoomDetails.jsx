  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col lg:flex-row mt-6 gap-6'>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length > 1 && room.images.map((image, index) => (
                    <img onClick={()=> setMainImage(image)} src={image} key={index} 
                    alt="room image" className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image && 'outline-3 outline-orange-500'}`}/>
                ))}
            </div>
        </div>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla doloremque voluptatibus voluptatem facilis esse laudantium vero harum eos dolorem consequatur, in iure aspernatur ipsa? Esse a ratione consequuntur debitis sapiente.</p>
        </div>
